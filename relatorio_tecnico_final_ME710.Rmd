...
packages= c("tidyverse","data.table","reshape2","captioner","gridExtra","xtable","ggpubr","MASS", "ggfortify","RiskPortfolios","stocks","PerformanceAnalytics","pastecs","psych","xtable","quadprog","knitr","scales", "kableExtra","PortfolioAnalytics","ROI","ROI.plugin.quadprog","tseries")
