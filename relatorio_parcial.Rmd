...
legenda_graf3 = figs(name="graf4_corre",caption = "Gráfico para estudo da correlação entre retornos. Quanto maior for o tamanho do círculo, maior será o vlor da correlação em módulo")
...
Se os dados vem de uma distribuição normal, $JB \sim \chi^2_{2}$. A Hipótese nula é a de que conjuntamente a assimeitria e o excesso de curtose são iguais a zero pois amostral que vem de distribuição normal tem assimetria igual a zero e excesso de curtose igual a zero, isto é, curtose igual a 3.
